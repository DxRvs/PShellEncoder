<#
<description>Start powershell process and use reg key for input and output
<description>
#>
<#
<categories>
...
$r = Invoke-WmiCommand  -Payload $sb -Credential $credential -ComputerName $rhost  -RegistryHive HKEY_LOCAL_MACHINE -RegistryKeyPath 'SOFTWARE\sql' -RegistryPayloadValueName 'value' -RegistryResultValueName 'result' -WaitRes 20  -Verbose 
echo $r.PayloadOutput
